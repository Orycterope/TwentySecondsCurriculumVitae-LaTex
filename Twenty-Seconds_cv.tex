...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\skills{{Git/5},{Unix/4.5}, {Windows/2}, {Shell/4.5},{Rust/5},{C/4.5}}
...
%%%%%%%%%%%%%%%%%%%%
\section{Profil}
Développeur motivé et rigoureux à la recherche d'un poste dans le milieu de l'embarqué et du développement système, qui apprécie le travail en équipe et l'échange d'idées. Formation out of the box et esprit touche-à-tout qui me rend versatile.
